      ...
      <div className="footer-m__container">
        <div className="footer-m__social">
          ...
          <ul className="social-links">
            ...
            <li><SocialLinkButton href={FACEBOOK_LINK} xlinkHref={`${socialLinks}#icon-facebook`}/>
            </li>
            <li><SocialLinkButton href={TWITTER_LINK} xlinkHref={`${socialLinks}#icon-twitter`}/>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-m__col-6">
          <div className="footer-m__item footer-m__col-6">
            ...
            <ul className="footer-m__list">
              ...
              <li className="footer-m__list-item">
                <Link to="/crags"
                      className="footer-m__list-link footer-m__list-link-disabled">Скалы</Link>
              </li>
            </ul>
          </div>
        </div>
